    ...
    try {
      if (isSignUp) {
        ...
        if (data.user && !data.session) {
          //session means user is authenticated and user mean user exists in db
          //combination of user existing and session not happening occurs while signup is when user has not confirmed their email yet
          //this is due to supabase, it sends you one confirmation mail when signing up
          //this can be turned off is needed
